...
function RecommendationBanner({ matchCount = 0, profileScore = 82, onImprove }) {
  return (
    <div className="flex flex-col items-start gap-5 rounded-2xl border border-brand-100 bg-brand-25/60 p-6 sm:flex-row sm:items-center sm:justify-between dark:border-brand-600/20 dark:bg-brand-600/10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-[#B5B5B5]">Based on your income, location and occupation.</p>
        </div>
      </div>
