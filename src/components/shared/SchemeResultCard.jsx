...
function SchemeResultCard({
  ...
  return (
    <Card hover className="flex flex-col gap-5 p-6">
        ...
        <button
          ...
          className={cn(
            ...
            bookmarked
              ...
              : "border-gray-100 text-gray-300 hover:border-brand-200 hover:text-brand-600"
          )}
        >
      ...
      <div className="grid grid-cols-2 gap-3 rounded-xl bg-gray-50/70 p-3.5 sm:grid-cols-4">
...
function Stat({ label, value, icon: Icon, highlight = false }) {
  return (
    <div className="flex flex-col items-center gap-1 text-center">
      <span className={cn("tabular-mono text-sm font-semibold", highlight ? "text-brand-700" : "text-ink")}>
        {value}
      </span>
